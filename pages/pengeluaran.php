<?php
/**
 * Halaman Manajemen Pengeluaran - CRUD
 */
...
$sql_kategori = "SELECT * FROM kategori_pengeluaran ORDER BY nama_kategori";
...
$sql_count = "SELECT COUNT(*) as total FROM pengeluaran p $where_clause";
...
<div class="container">
    <h2 style="margin-bottom: 2rem;">💸 Manajemen Pengeluaran</h2>
    ...
    <!-- Form Tambah/Ubah Pengeluaran -->
    <div class="form-container" id="formPengeluaran" style="display: none;">
        <h3 id="formTitle">Tambah Pengeluaran Baru</h3>
        <form id="formPengeluaranInput" method="POST" action="process_pengeluaran.php">
    ...
    <div style="margin-bottom: 1.5rem;">
        <button class="btn btn-success" onclick="showAddForm()">+ Tambah Pengeluaran</button>
    </div>
    ...
    <div class="search-filter">
        <form method="GET" style="display: flex; gap: 1rem; width: 100%;">
            ...
            <a href="pengeluaran.php" class="btn btn-warning">Reset</a>
        </form>
    </div>
    ...
    <div class="table-container">
        <div class="table-header">
            <h3 class="table-title">Daftar Pengeluaran (<?php echo number_format($total_data); ?> data)</h3>
        </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="process_pengeluaran.php?action=hapus&id=<?php echo $row['id']; ?>" 
                                   class="btn btn-danger btn-sm" 
                                   onclick="return confirmDelete('Apakah Anda yakin ingin menghapus pengeluaran ini?')">Hapus</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
...
function showAddForm() {
    ...
    document.getElementById('formTitle').textContent = 'Tambah Pengeluaran Baru';
    document.getElementById('inputAction').value = 'tambah';
    document.getElementById('formPengeluaranInput').reset();
...
document.getElementById('formPengeluaranInput').addEventListener('submit', function(e) {
    if (!validateForm('formPengeluaranInput')) {
        e.preventDefault();
